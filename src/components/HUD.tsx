...
export const HUD = (props: Props) => {
  return (
    <div className={clsx('p-1', props.className)}>
      <section className={clsx('leading-[1.2] text-cyan-500 uppercase')}>
      ...
      <section className="mt-8 text-cyan-500 uppercase">
        <p>Session ID</p>
      ...
      <section className="mt-8 uppercase">
        <p className="text-cyan-500/60">Analyze</p>

        <div className={clsx('flex gap-1 items-center', 'text-cyan-500')}>
          <p>Search</p>
          <ChevronLeftIcon className="size-5" />
        </div>

        <p className="text-cyan-500/60">Track</p>
        <p className="text-cyan-500/60">Command</p>
      </section>
    </div>
  )
}
